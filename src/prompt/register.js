  ...
  document.body.insertAdjacentHTML('afterbegin', `
    <div class="iBiometric_container" id="iBiometric_container_registrationWindow">
      <div class="iBiometric_dialog">
        ...
        <h2>Update</h2>
        <p>update_id=local32: Reduce the number of times you have to login for payment. Use your screen lock credentials for logging in and make it easy for you to login and make payments.</p>
